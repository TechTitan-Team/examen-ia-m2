...
import { User, Lock, Eye, EyeSlash, Envelope } from "@phosphor-icons/react";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row">
        {/* Left Section - Signup Form (50%) */}
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          {/* Logo */}
          <div className="flex items-center gap-2 mb-8">
            <div className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center">
              {/* Voambolana.ai Logo - V stylized with text lines */}
              <svg
          ...
          <h1 className="text-4xl font-bold text-gray-800 mb-2">
            Mamorona ny kaontinao
          </h1>
          <p className="text-gray-500 mb-8">
            Misoratra anarana amin'ny alalan'ny fampidirana ny fampahalalana eto ambany
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Anaram-pianakaviana"
                className="w-full pl-12 pr-4 py-3 bg-gray-100 rounded-lg border-none focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700 placeholder-gray-400"
                required
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Hamafiso ny tenimiafina"
                className="w-full pl-12 pr-12 py-3 bg-gray-100 rounded-lg border-none focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-700 placeholder-gray-400"
                required
              />
              <button
            ...
            <div className="flex items-center gap-4">
              ...
              >
                {loading ? "Misoratra anarana..." : "Misoratra anarana"}
              </button>
              <Link
                to="/login"
        ...
        <div className="w-full md:w-1/2 relative overflow-hidden flex items-center justify-center p-8">
          ...
          >
            <defs>
              ...
              <radialGradient id="radiantMainSignup" cx="30%" cy="20%" r="80%">
              ...
              <radialGradient id="darkShapeSignup" cx="50%" cy="50%">
              ...
              <radialGradient id="softCurveSignup" cx="0%" cy="100%">
              ...
              <radialGradient id="overlayGradientSignup" cx="70%" cy="40%">
            ...
            <rect width="1000" height="800" fill="url(#radiantMainSignup)" />

            {/* Large dark blue rounded shape top-right */}
            <ellipse cx="900" cy="50" rx="500" ry="450" fill="url(#darkShapeSignup)" />

            {/* Soft elongated curve bottom-left */}
            <ellipse cx="100" cy="750" rx="400" ry="200" fill="url(#softCurveSignup)" />

            {/* Additional soft overlay */}
            <ellipse cx="700" cy="300" rx="350" ry="300" fill="url(#overlayGradientSignup)" />
          ...
          <div className="relative z-10 flex items-center justify-center w-full h-full">
            <div className="relative" style={{ transform: "perspective(1000px) rotateX(15deg) rotateY(-15deg)" }}>
              ...
              >
                ...
                >
                  {/* Logo Voambolana.ai on document - centered horizontally */}
